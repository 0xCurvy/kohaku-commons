...
export type CurvyTestStatus = 'idle' | 'initializing' | 'ready' | 'error'

export class CurvyTestController extends EventEmitter {
  ...
  async init(params: {
    ...
    try {
      ...
      console.error('[CurvyTestController] init failed:', e)
      this.status = 'error'
